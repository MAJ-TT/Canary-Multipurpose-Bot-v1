              ...
              client.embed(
                {
                  title: `🥇・Badges`,
                  thumbnail:
                    "https://media.discordapp.net/attachments/937337957419999272/938725906728513576/techpoint_channel_banner_badges.jpg?width=813&height=221",
        ...
        if (message == "credits") {
          client
            ...
            .then(() => {
              client.embed(
                {
                  title: `${client.user.username}・Sea Credits`,
                  author: {
                    name: "TechPoint",
                    iconURL:
                      "https://media.discordapp.net/attachments/937337957419999272/937797574440681472/techpoint_logo-min.jpg?width=812&height=812",
                  ...
                  fields: [
                    {
                      name: `ℹ️┆What are Sea Credits?`,
                      value: `Sea Credits are credits you get when you perform certain actions! You can exchange this for nice benefits for you and your server`,
                    },
                    {
                      name: `❓┆How do you get Sea Credits?`,
                      value: `Currently you only get Sea Credits when you vote on Bot. You can do this on top.gg! The credits will then be automatically added to your account!`,
                    },
                    {
                      name: `💱┆What can you exchange Sea Credits for?`,
                    ...
                    {
                      name: `🎁┆How do I redeem Sea Credits?`,
                      value: `For a background pack: \`/Sea Credits backgroundpack\`\nFor a logo pack: \`/Sea Credits logopack\`\nFor a sticker pack: \`/Sea Credits stickerpack\`\nFor a 1 year pack: \`/Sea Credits 1yearpack\``,
                    },
                    {
