        ...
        if (message == "credits") {
          client
            ...
            .then(() => {
              client.embed(
                {
                  title: `${client.user.username} Credits`,
                  author: {
                    name: "X",
                    iconURL:
                      "https://media.discordapp.net/attachments/937337957419999272/937797574440681472/techpoint_logo-min.jpg?width=812&height=812",
                  ...
                  fields: [
                    {
                      name: `ℹ️┆What are Credits?`,
                      value: `Credits are what you get when you perform certain actions! You can exchange this for nice benefits for you and your server`,
                    },
                    {
                      name: `❓┆How do you get  Credits?`,
                      value: `Currently you only get Credits when you vote on Bot. You can do this on top.gg! The credits will then be automatically added to your account!`,
                    },
                    {
                      name: `💱┆What can you exchange Credits for?`,
                    ...
                    {
                      name: `🎁┆How do I redeem Credits?`,
                      value: `For a background pack: \`/Credits backgroundpack\`\nFor a logo pack: \`/Credits logopack\`\nFor a sticker pack: \`/Credits stickerpack\`\nFor a 1 year pack: \`/Credits 1yearpack\``,
                    },
                    {
